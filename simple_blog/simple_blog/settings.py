...
SECRET_KEY = 'django-insecure-%vm%q_90g)8dns@e!k*j-b9xa*3svx)7b5$gj-wy^7v-z^wj-g'
...
LOGIN_REDIRECT_URL = 'post_list'  # This should match the name of the URL pattern for your post list
